...
def main():
    ...
    rg_name = 'v1copyBlobToSqlRg'

    # The data factory name. It must be globally unique.
    df_name = 'v1copyBlobToSqlDf'
    ...
    ls_azure_sql_storage = AzureSqlDatabaseLinkedService(connection_string ='server:',password = '*******',service_principal_id = '',type ='AzureSqlDatabase')
